...
const translations = {
  en: {
    ...
    // InstaLaw
    "instaLaw.title": "InstaLaw",
    "instaLaw.subtitle": "Instant Legal Guidance",
    "instaLaw.backToHome": "Back to Home",
    "instaLaw.emergencyCall": "Emergency? Call 999 immediately",
    "instaLaw.knowRights": "Know Your Rights, Know What To Do",
    "instaLaw.description":
      "Get instant, step-by-step legal guidance based on Bangladesh law. Whether you're a victim, witness, or being accused, this tool will help you understand your rights and take the right actions.",
    "instaLaw.tellSituation": "Tell us about your situation",
    "instaLaw.userRole": "What is your role in this situation?",
    "instaLaw.chooseRole": "Choose your role to get personalized guidance",
    "instaLaw.victim": "I am a victim",
    "instaLaw.victimDesc": "Something happened to you",
    "instaLaw.witness": "I am a witness",
    "instaLaw.witnessDesc": "You saw something happen",
    "instaLaw.accused": "I am being accused",
    "instaLaw.accusedDesc": "You are being blamed for something",
    "instaLaw.incidentType": "Type of incident",
    "instaLaw.incidentDetails": "Incident Details",
    "instaLaw.selectIncident": "Select the type of incident",
    "instaLaw.specifyIncident": "Please specify the incident",
    "instaLaw.describeIncident": "Describe what happened",
    "instaLaw.describeIncidentPlaceholder": "Briefly describe the incident",
    "instaLaw.location": "Location of incident",
    "instaLaw.locationPlaceholder": "City, district, or specific location",
    "instaLaw.timeOfIncident": "Time of incident (optional)",
    "instaLaw.immediateDanger": "Are you in immediate danger?",
    "instaLaw.yes": "Yes",
    "instaLaw.no": "No",
    "instaLaw.additionalContext": "Additional details (optional)",
    "instaLaw.additionalDetails": "Additional Details",
    "instaLaw.optionalInfo":
      "This information helps us give you better guidance",
    "instaLaw.contextPlaceholder":
      "Provide any additional details that might help us give you better guidance",
    "instaLaw.getGuide": "Get My Action Guide",
    "instaLaw.personalizedGuide": "Your Personalized Action Guide",
    "instaLaw.downloadGuide": "Download Guide",
    "instaLaw.newSituation": "New Situation",
    "instaLaw.dangerDetected": "IMMEDIATE DANGER DETECTED",
    "instaLaw.callNow":
      "Call 999 now for emergency assistance. Your safety is the top priority.",
    "instaLaw.emergencyContacts": "Emergency Contacts",
    "instaLaw.continue": "Continue",
    "instaLaw.back": "Back",
    "instaLaw.progress.role": "Choose Role",
    "instaLaw.progress.incident": "Describe Incident",
    "instaLaw.progress.steps": "Get Steps",
    "instaLaw.step1.titleDanger": "What To Do RIGHT NOW",
    "instaLaw.step1.titleSafe": "What To Do Immediately",
    "instaLaw.step2.title": "Where To Go",
    "instaLaw.step3.title": "Documents To Collect",
    "instaLaw.step4.title": "Your Legal Rights",
    "instaLaw.aiDisclaimer": "AI-Generated Legal Guide",
    "instaLaw.disclaimer":
      "This is an AI-generated legal guide based on Bangladesh law. For urgent help, contact a lawyer or local police station. Laws may vary by jurisdiction and circumstances.",
  ...
  bn: {
    ...
    // InstaLaw
    "instaLaw.title": "ইনস্টালো",
    "instaLaw.subtitle": "তাৎক্ষণিক আইনি নির্দেশনা",
    "instaLaw.backToHome": "হোমে ফিরুন",
    "instaLaw.emergencyCall": "জরুরি? এখনই ৯৯৯ এ কল করুন",
    "instaLaw.knowRights": "আপনার অধিকার জানুন, কী করতে হবে জানুন",
    "instaLaw.description":
    ...
    "instaLaw.tellSituation": "আপনার পরিস্থিতি সম্পর্কে বলুন",
    "instaLaw.userRole": "এই পরিস্থিতিতে আপনার ভূমিকা কী?",
    "instaLaw.chooseRole": "ব্যক্তিগত নির্দেশনা পেতে আপনার ভূমিকা বেছে নিন",
    "instaLaw.victim": "আমি একজন ভুক্তভোগী",
    "instaLaw.victimDesc": "আপনার সাথে কিছু ঘটেছে",
    "instaLaw.witness": "আমি একজন সাক্ষী",
    "instaLaw.witnessDesc": "আপনি কিছু ঘটতে দেখেছেন",
    "instaLaw.accused": "আমি অভিযুক্ত",
    "instaLaw.accusedDesc": "আপনাকে কিছুর জন্য দোষারোপ করা হচ্ছে",
    "instaLaw.incidentType": "ঘটনার ধরন",
    "instaLaw.incidentDetails": "ঘটনার বিবরণ",
    "instaLaw.selectIncident": "ঘটনার ধরন নির্বাচন করুন",
    "instaLaw.specifyIncident": "অনুগ্রহ করে ঘটনাটি নির্দিষ্ট করুন",
    "instaLaw.describeIncident": "কী ঘটেছে তা বর্ণনা করুন",
    "instaLaw.describeIncidentPlaceholder": "সংক্ষেপে ঘটনাটি বর্ণনা করুন",
    "instaLaw.location": "ঘটনার স্থান",
    "instaLaw.locationPlaceholder": "শহর, জেলা বা নির্দিষ্ট স্থান",
    "instaLaw.timeOfIncident": "ঘটনার সময় (ঐচ্ছিক)",
    "instaLaw.immediateDanger": "আপনি কি তাৎক্ষণিক বিপদে আছেন?",
    "instaLaw.yes": "হ্যাঁ",
    "instaLaw.no": "না",
    "instaLaw.additionalContext": "অতিরিক্ত বিবরণ (ঐচ্ছিক)",
    "instaLaw.additionalDetails": "অতিরিক্ত বিবরণ",
    "instaLaw.optionalInfo":
      "এই তথ্য আমাদের আরও ভাল নির্দেশনা দিতে সাহায্য করে",
    "instaLaw.contextPlaceholder":
      "আমাদের আরও ভাল নির্দেশনা দিতে সাহায্য করতে পারে এমন কোনো অতিরিক্ত বিবরণ প্রদান করুন",
    "instaLaw.getGuide": "আমার কর্মপরিকল্পনা পান",
    "instaLaw.personalizedGuide": "আপনার ব্যক্তিগত কর্মপরিকল্পনা",
    "instaLaw.downloadGuide": "গাইড ডাউনলোড করুন",
    "instaLaw.newSituation": "নতুন পরিস্থিতি",
    "instaLaw.dangerDetected": "তাৎক্ষণিক বিপদ শনাক্ত করা হয়েছে",
    "instaLaw.callNow":
      "জরুরি সহায়তার জন্য এখনই ৯৯৯ এ কল করুন। আপনার নিরাপত্তাই সর্বোচ্চ অগ্রাধিকার।",
    "instaLaw.emergencyContacts": "জরুরি যোগাযোগ",
    "instaLaw.continue": "এগিয়ে যান",
    "instaLaw.back": "পিছনে",
    "instaLaw.progress.role": "ভূমিকা বেছে নিন",
    "instaLaw.progress.incident": "ঘটনা বর্ণনা করুন",
    "instaLaw.progress.steps": "পদক্ষেপ পান",
    "instaLaw.step1.titleDanger": "এখনই কী করতে হবে",
    "instaLaw.step1.titleSafe": "তাৎক্ষণিক কী করতে হবে",
    "instaLaw.step2.title": "কোথায় যেতে হবে",
    "instaLaw.step3.title": "যে কাগজপত্র সংগ্রহ করতে হবে",
    "instaLaw.step4.title": "আপনার আইনি অধিকার",
    "instaLaw.aiDisclaimer": "এআই-উৎপন্ন আইনি গাইড",
    "instaLaw.disclaimer":
      "এটি বাংলাদেশের আইনের উপর ভিত্তি করে একটি এআই-উৎপন্ন আইনি গাইড। জরুরি সাহায্যের জন্য একজন আইনজীবী বা স্থানীয় থানার সাথে যোগাযোগ করুন। আইন এখতিয়ার এবং পরিস্থিতি অনুযায়ী ভিন্ন হতে পারে।",
